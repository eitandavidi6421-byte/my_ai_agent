const fs = require('fs');
let txt = fs.readFileSync('c:/Users/IMOE001/Documents/הבינה המלכותית שלי/background.js', 'utf8');
...
txt = txt.substring(0, startIdx) + inside + '\n`;\n// ═════════════════════════════\n' + txt.substring(txt.indexOf('function getWorkerPrompt()', endIdx));

fs.writeFileSync('c:/Users/IMOE001/Documents/הבינה המלכותית שלי/background.js', txt, 'utf8');
console.log('Fixed');
